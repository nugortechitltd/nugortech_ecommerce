...
<!-- Mirrored from reactheme.com/products/html/weiboo/error.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Mar 2023 06:50:03 GMT -->
<head>
    <meta charset="UTF-8">
            ...
            <div class="container">
                <div class="error-404">
                    <div class="section-inner">
                        <div class="error-img">
                            <img src="{{asset('frontend/assets/images/error/404-1.png')}}" alt="error-img">
                        </div>
                        <div class="title">
                        ...
                        <div class="section-button">
                            <a href="{{route('site')}}"><i class="fal fa-long-arrow-left"></i> Go To Homepage</a>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from reactheme.com/products/html/weiboo/error.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Mar 2023 06:50:04 GMT -->
</html>
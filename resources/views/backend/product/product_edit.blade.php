    ...
    <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
        <div>
            ...
            <p class="breadcrumbs"><span><a href="{{route('home')}}">Dashboard</a></span>
                <span><i class="mdi mdi-chevron-right"></i></span>Product update</p>
        </div>
        <div>
                    ...
                    <div class="row ec-vendor-uploads">
                        <div class="col-lg-12">
                            <div class="ec-vendor-upload-detail">
                                <form class="row g-3" method="post" enctype="multipart/form-data" action="{{route('product.update')}}">
                                    @csrf
                                    ...
                                    <div class="col-md-6 mt-3">
                                        ...
                                        <select name="brand_id">
                                            ...
                                            @foreach ($brand as $brand)
                                             <option value="{{$brand->id}}" {{$brand->id ? 'selected': ''}}>{{$brand->brand_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-6 mt-3">
                                    ...
                                    <div class="col-md-6 mt-3">
                                        ...
                                        <input type="number" name="discount" class="form-control " placeholder="Product discount" value="{{$product->discount}}">
                                    </div>
                                    <div class="col-md-12 mt-3">
                                        <label for="inputEmail11" class="form-label">Short description</label>
                                        <input type="text" name="short_desp" class="form-control" placeholder="Product short description" value="{{$product->short_desp}}">
                                        @error('short_desp')
                                            <strong class="text-danger">{{$message}}</strong>
                                        @enderror
                                    </div>
                                    <div class="col-md-12 mt-3">
                                        ...
                                        <textarea id="summernote" name="long_desc" class="form-control" placeholder="Product description">{!! $product->long_desc !!}</textarea>
                                        @error('long_desc')
                                            <strong class="text-danger">{{$message}}</strong>
                                        @enderror
                                    </div>
                                    <div class="col-md-12 mt-3">
                                        ...
                                        <textarea id="summernote2" name="additional_desc" class="form-control" placeholder="additional information">{!! $product->additional_desc !!}</textarea>
                                    ...
                                    <div class="form_customer_profilr_img col-md-6 mt-3">
                                        ...
                                        @error('preview_one')
                                            <strong class="text-danger">{{$message}}</strong>
                                        @enderror
                                        <img width="100" class="mt-3 mb-3" id="image1" height="auto" src="{{asset('uploads/products/preview')}}/{{$product->preview_one}}" alt="">
                                    </div>
                                    <div class="form_customer_profilr_img col-md-6 mt-3">
                                        ...
                                        @error('preview_two')
                                            <strong class="text-danger">{{$message}}</strong>
                                        @enderror
                                        <img width="100" class="mt-3 mb-3" id="image2" height="auto" src="{{asset('uploads/products/preview')}}/{{$product->preview_two}}" alt="">
                                    </div>
                                    <div class="form_customer_profilr_img col-md-12 mt-3">
                                        ...
                                        <img width="100" class="mt-3 mb-3" id="image2" height="auto" src="{{asset('uploads/products/thumbnail')}}/{{$thumb->thumbnail}}" alt="">
                                        @endforeach
                                    </div>
